...
## 其他
为了增强可读性, 此代码包含笔记, 试卷(现已移除). 不需要的话可以自己删除(懂一点点代码就可以).其中几个笔记有错误, 因为版本混淆修改未提交.   
如果笔记试卷等资源侵了你的权, 请联系我删除.(真可惜里面大部分东西都没被我用, 可我上传笔记试卷却特别积极)  
...
7.Logo里面的星星来源于 Surface自带的"Paint 3D"软件,  
8. [以外的部分非我制作的资源......]

我制作的资源你们可以免费用,  高考后继续开源我的其他更好的工具!    
加密算法请自己更换.   
